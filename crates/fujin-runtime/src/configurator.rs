...
use fujin_configurator::{
    ApplyResult, ApplyState, ConnectorRuntime, ConnectorRuntimeStatus, ConnectorSnapshot,
    RuntimeError, connector_digest,
};
#[cfg(test)]
use fujin_configurator::{
    Configurator, ConfiguratorPlugin, ConfiguratorRegistry, RuntimeConfig, bootstrap_snapshot,
};
use fujin_connector::{Catalog, CatalogStatus, ConnectorsConfig};
...
mod tests {
    ...
    fn connectors(version: &str) -> ConnectorsConfig {
        BTreeMap::from([(
            "main".into(),
            fujin_connector::ConnectorConfig {
