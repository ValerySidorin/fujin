...
func init() {
	writer.RegisterWriterFactory("redis_pubsub", func(rawBrokerConfig any, writerID string, l *slog.Logger) (writer.Writer, error) {
	...
	reader.RegisterReaderFactory("redis_pubsub", func(rawBrokerConfig any, autoCommit bool, l *slog.Logger) (reader.Reader, error) {
