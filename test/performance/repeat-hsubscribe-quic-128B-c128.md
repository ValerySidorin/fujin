...
**Generated:** 2026-08-23T02:29:43.737002+00:00
**Source:** `d6ee3c6`
**Cells:** 1
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| overall | 1 | 1.849x | 1.305x | n/a | n/a | 0 | 1 | 1 |
| operation/hsubscribe | 1 | 1.849x | 1.305x | n/a | n/a | 0 | 1 | 1 |
| transport/quic | 1 | 1.849x | 1.305x | n/a | n/a | 0 | 1 | 1 |

## Worst median latency ratios

| Cell | Samples | Go ns/op | Rust ns/op | Rust/Go | p-value |
|---|---:|---:|---:|---:|---:|
| `hsubscribe/quic/128B/1/128` | 10 | 2269 | 4194 | 1.849x | 0.0002 |
