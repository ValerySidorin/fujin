...
**Generated:** 2026-08-23T02:37:11.925854+00:00
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| overall | 1 | 1.189x | 2.100x | n/a | n/a | 0 | 1 | 1 |
| operation/transaction | 1 | 1.189x | 2.100x | n/a | n/a | 0 | 1 | 1 |
| transport/quic | 1 | 1.189x | 2.100x | n/a | n/a | 0 | 1 | 1 |

## Worst median latency ratios

| Cell | Samples | Go ns/op | Rust ns/op | Rust/Go | p-value |
|---|---:|---:|---:|---:|---:|
| `transaction/quic/1KiB/1/128` | 10 | 10674 | 12689 | 1.189x | 0.0002 |
