...
type FujinResponse_Ack struct {
	Ack *Empty `protobuf:"bytes,4,opt,name=ack,proto3,oneof"`
}

type FujinResponse_Nack struct {
	Nack *Empty `protobuf:"bytes,5,opt,name=nack,proto3,oneof"`
}
...
const file_internal_api_grpc_v1_fujin_proto_rawDesc = "" +
	...
	"autoCommit\x12*\n" +
	"\aheaders\x18\x04 \x03(\v2\x10.fujin.v1.HeaderR\aheaders\"\xad\x01\n" +
	"\aMessage\x12%\n" +
	"\x0ecorrelation_id\x18\x01 \x01(\rR\rcorrelationId\x12\x14\n" +
	"\x05topic\x18\x02 \x01(\tR\x05topic\x12\x18\n" +
	...
	"\amessage\x18\x03 \x01(\v2\x11.fujin.v1.MessageH\x00R\amessage\x12#\n" +
	"\x03ack\x18\x04 \x01(\v2\x0f.fujin.v1.EmptyH\x00R\x03ack\x12%\n" +
	"\x04nack\x18\x05 \x01(\v2\x0f.fujin.v1.EmptyH\x00R\x04nackB\n" +
	"\n" +
	"\bresponse2M\n" +
	"\fFujinService\x12=\n" +
	"\x06Stream\x12\x16.fujin.v1.FujinRequest\x1a\x17.fujin.v1.FujinResponse(\x010\x01B\xaa\x01\n" +
	"\fcom.fujin.v1B\n" +
	"FujinProtoP\x01ZMgithub.com/ValerySidorin/fujin/internal/api/grpc/internal/api/grpc/v1;fujinv1\xa2\x02\x03FXX\xaa\x02\bFujin.V1\xca\x02\bFujin\\V1\xe2\x02\x14Fujin\\V1\\GPBMetadata\xea\x02\tFujin::V1b\x06proto3"
...
var file_internal_api_grpc_v1_fujin_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_internal_api_grpc_v1_fujin_proto_goTypes = []any{
	...
	(*Message)(nil),          // 6: fujin.v1.Message
	(*AckRequest)(nil),       // 7: fujin.v1.AckRequest
	(*NackRequest)(nil),      // 8: fujin.v1.NackRequest
	(*Empty)(nil),            // 9: fujin.v1.Empty
	(*FujinRequest)(nil),     // 10: fujin.v1.FujinRequest
	(*FujinResponse)(nil),    // 11: fujin.v1.FujinResponse
}
var file_internal_api_grpc_v1_fujin_proto_depIdxs = []int32{
	...
	7,  // 6: fujin.v1.FujinRequest.ack:type_name -> fujin.v1.AckRequest
	8,  // 7: fujin.v1.FujinRequest.nack:type_name -> fujin.v1.NackRequest
	...
	6,  // 10: fujin.v1.FujinResponse.message:type_name -> fujin.v1.Message
	9,  // 11: fujin.v1.FujinResponse.ack:type_name -> fujin.v1.Empty
	9,  // 12: fujin.v1.FujinResponse.nack:type_name -> fujin.v1.Empty
	10, // 13: fujin.v1.FujinService.Stream:input_type -> fujin.v1.FujinRequest
	11, // 14: fujin.v1.FujinService.Stream:output_type -> fujin.v1.FujinResponse
...
func file_internal_api_grpc_v1_fujin_proto_init() {
	...
	file_internal_api_grpc_v1_fujin_proto_msgTypes[10].OneofWrappers = []any{
